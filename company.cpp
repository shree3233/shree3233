...
void deleteIndex(int i){ for(int j = 
i;j<num;j++){ emp[j].name = 
emp[j+1].name; 
...
cout<<setw(5)<<emp[i].employee_id<<setw(10)<<emp[i].name<<setw(18)<<emp[i].designation<<setw( 
10)<<emp[i].salary<<endl; 
 } 
 } 
} 
void deleteRecord(){ 
...
cin>>employee_id; for(int i=0;i<num+1;i++){ 
